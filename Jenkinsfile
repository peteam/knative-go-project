pipeline {
  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/peteam/knative-go-project') {
            checkout scm
          ...
          dir('/home/jenkins/go/src/github.com/peteam/knative-go-project/charts/preview') {
            sh "make preview"
    ...
    stage('Promote to Environments') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/peteam/knative-go-project/charts/knative-go-project') {
